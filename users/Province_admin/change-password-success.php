...
{
$sql=mysqli_query($con,"SELECT password FROM  users where password='".md5($_POST['password'])."' && userEmail='".$_SESSION['plogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update users set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where userEmail='".$_SESSION['plogin']."'");
			...
			<div class="container-fluid">
				...
				<div class="row">
  	        	  ...
  	        	  <?php if(empty($errormsg))
                      ...
                      <b>Well done!</b> <?php echo "Password Changed Successfully !!";?></div>
                      <?php }?>
