...
$query222=mysqli_query($con,"SELECT COUNT(feedbackValue),feedbackValue from feedback where province = '".$_SESSION['province']."' GROUP BY feedbackValue");
					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
                             ...
                             <?php
                             $Excellent = 'Excellent';
$rt = mysqli_query($con,"SELECT * FROM feedback where feedbackValue = '$Excellent' and province = '".$_SESSION['province']."'");
...
{?>
                   ...
                   <?php 
                $Good = 'Good';
$rt = mysqli_query($con,"SELECT * FROM feedback where feedbackValue = '$Good' and province = '".$_SESSION['province']."'");
$num1 = mysqli_num_rows($rt);
{?>									<div class="stat-panel-number h1 "><?php echo htmlentities($num1);?></div>
										...
										<div class="panel panel-default">
											<div class="panel-body bk-nathural text-light">
												<div class="stat-panel text-center">
												     <?php 
                 $Neutral = 'Neutral';
$rt = mysqli_query($con,"SELECT * FROM feedback where feedbackValue ='$Neutral' and province = '".$_SESSION['province']."'");
$num1 = mysqli_num_rows($rt);
{?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($num1);?></div>
													<?php }?>
										...
										<div class="panel panel-default">
											<div class="panel-body bk-poor text-light">
												<div class="stat-panel text-center">
												     <?php 
                  $Poor = 'Poor';
$rt = mysqli_query($con,"SELECT * FROM feedback where feedbackValue ='$Poor' and province = '".$_SESSION['province']."'");
$num1 = mysqli_num_rows($rt);
{?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($num1);?></div>
													<?php }?>
										...
										<div class="panel panel-default">
											<div class="panel-body bk-verypoor text-light">
												<div class="stat-panel text-center">
												     <?php 
               $VeryPoor = 'VeryPoor';
$rt = mysqli_query($con,"SELECT * FROM feedback where feedbackValue ='$VeryPoor' and province = '".$_SESSION['province']."'");
$num1 = mysqli_num_rows($rt);
{?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($num1);?></div>
													<?php }?>
...
$rt = mysqli_query($con,"SELECT * FROM feedback where province = '".$_SESSION['province']."'");
$num1 = mysqli_num_rows($rt);
{?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($num1);?></div>
													<?php }?>
...
$rt = mysqli_query($con,"SELECT * FROM feedback where province = '".$_SESSION['province']."' Group By userEmail");
$num1 = mysqli_num_rows($rt);
{?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($num1);?></div>
													<?php }?>
 ...
 <?php $query=mysqli_query($con,"select feedbackValue,COUNT(feedbackValue) AS MOST_FREQUENT from feedback where province = '".$_SESSION['province']."' GROUP BY feedbackValue ORDER BY COUNT(feedbackValue) DESC LIMIT 1");
while($row=mysqli_fetch_array($query))
{
?>							
													<?php 
