...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"UPDATE tblpages SET detail='$pagedetails' WHERE type='$pagetype'");
	$_SESSION['msg']="Page data updated  successfull";
}
}
?>
...
<?php } ?>
			...
			<textarea class="form-control" rows="5" cols="50" name="pgedetails" id="pgedetails" placeholder="Package Details" required>
										...
										<?php
$pagetype=$_GET['type'];
$query=mysqli_query($con,"SELECT detail from tblpages where type='$pagetype'");
while($row=mysqli_fetch_array($query))
{
?>	
