...
if(isset($_POST['submit']))
{
  ...
  {
    $nicerrormsg="NIC is Invalid.User Not Added !!";
  }
...
<form name="state" method="post" class="form-horizontal" onsubmit="return phoneno()">
	<p style="padding-left: 1%; color: green">
            ...
            <p style="padding-left: 1%; color: red">
              <?php if(isset($nicerrormsg)){
            echo htmlentities($nicerrormsg);
                }?>
            </p>
...
<div class="col-sm-4">
<input type="text" name="nic" id="nic" class="form-control" onBlur="usernic()" placeholder="NIC" required>
