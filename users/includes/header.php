<div class="brand clearfix">
    ...
    padding-left: 5px;
"> 
<a href="?lang=en"  <?php if($lang == 'en'){?> style="color:#ff9900;" <?php } ?>><font size="3px" style="color:#ff9900;">English</font></a>&nbsp;<font size="3px" style="color:white;">|</font>&nbsp;
<a href="?lang=si"  <?php if($lang == 'si'){?> style="color:#ff9900;" <?php } ?>><font size="3px" style="color:#ff9900;">සිංහල</font></a>&nbsp;<font size="3px" style="color:white;">|</font>&nbsp;
<a href="?lang=ta"  <?php if($lang == 'ta'){?> style="color:#ff9900;" <?php } ?>><font size="2px" style="color:#ff9900;">தமிழ்</font></a></selection>
