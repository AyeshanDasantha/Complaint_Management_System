...
include('states/Ampara.php');
include('states/Batticaloa.php');
include('states/Trincomalee.php');
include('states/Kandy.php');
include('states/Matale.php');
include('states/NuwaraEliya.php');
include('states/Badulla.php');
include('states/Monaragala.php');
include('states/Colombo.php');
include('states/Gampaha.php');
include('states/Kalutara.php');
include('states/Galle.php');
include('states/Hambantota.php');
include('states/Matara.php');
include('states/Kegalle.php');
include('states/Ratnapura.php');
include('states/Jaffna.php');
include('states/Kilinochchi.php');
include('states/Mannar.php');
include('states/Mullaitivu.php');
include('states/Vavuniya.php');
include('states/Kurunegala.php');
include('states/Puttalam.php');
include('states/Anuradhapura.php');
include('states/Polonnaruwa.php');
...
window.JSMaps.maps.sriLanka = {
	...
	"paths": [

		{
			...
			"text": "<h1>Batticaloa</h1><br /><p><?php echo "All Complaint : ".$Batticaloa_all."<br>"."Not Process Complaint : ".$Batticaloa_not."<br>"."In Process Complaint : ".$Batticaloa_in."<br>"."Closed Complaint : ".$Batticaloa_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Mannar</h1><br /><p><?php echo "All Complaint : ".$Mannar_all."<br>"."Not Process Complaint : ".$Mannar_not."<br>"."In Process Complaint : ".$Mannar_in."<br>"."Closed Complaint : ".$Mannar_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Jaffna</h1><br /><p><?php echo "All Complaint : ".$Jaffna_all."<br>"."Not Process Complaint : ".$Jaffna_not."<br>"."In Process Complaint : ".$Jaffna_in."<br>"."Closed Complaint : ".$Jaffna_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Kilinochchi</h1><br /><p><?php echo "All Complaint : ".$Kilinochchi_all."<br>"."Not Process Complaint : ".$Kilinochchi_not."<br>"."In Process Complaint : ".$Kilinochchi_in."<br>"."Closed Complaint : ".$Kilinochchi_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Kandy</h1><br /><p><?php echo "All Complaint : ".$Kandy_all."<br>"."Not Process Complaint : ".$Kandy_not."<br>"."In Process Complaint : ".$Kandy_in."<br>"."Closed Complaint : ".$Kandy_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Matale</h1><br /><p><?php echo "All Complaint : ".$Matale_all."<br>"."Not Process Complaint : ".$Matale_not."<br>"."In Process Complaint : ".$Matale_in."<br>"."Closed Complaint : ".$Matale_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Nuvara Eliya</h1><br /><p><?php echo "All Complaint : ".$NuwaraEliya_all."<br>"."Not Process Complaint : ".$NuwaraEliya_not."<br>"."In Process Complaint : ".$NuwaraEliya_in."<br>"."Closed Complaint : ".$NuwaraEliya_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Ampara</h1><br /><p><?php echo "All Complaint : ".$Ampara_all."<br>"."Not Process Complaint : ".$Ampara_not."<br>"."In Process Complaint : ".$Ampara_in."<br>"."Closed Complaint : ".$Ampara_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Polonnaruwa</h1><br /><p><?php echo "All Complaint : ".$Polonnaruwa_all."<br>"."Not Process Complaint : ".$Polonnaruwa_not."<br>"."In Process Complaint : ".$Polonnaruwa_in."<br>"."Closed Complaint : ".$Polonnaruwa_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Trincomalee</h1><br /><p><?php echo "All Complaint : ".$Trincomalee_all."<br>"."Not Process Complaint : ".$Trincomalee_not."<br>"."In Process Complaint : ".$Trincomaleea_in."<br>"."Closed Complaint : ".$Trincomalee_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Anuradhapura</h1><br /><p><?php echo "All Complaint : ".$Anuradhapura_all."<br>"."Not Process Complaint : ".$Anuradhapura_not."<br>"."In Process Complaint : ".$Anuradhapura_in."<br>"."Closed Complaint : ".$Anuradhapura_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Vavuniya</h1><br /><p><?php echo "All Complaint : ".$Vavuniya_all."<br>"."Not Process Complaint : ".$Vavuniya_not."<br>"."In Process Complaint : ".$Vavuniya_in."<br>"."Closed Complaint : ".$Vavuniya_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Mulativu</h1><br /><p><?php echo "All Complaint : ".$Mullaitivu_all."<br>"."Not Process Complaint : ".$Mullaitivu_not."<br>"."In Process Complaint : ".$Mullaitivu_in."<br>"."Closed Complaint : ".$Mullaitivu_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Kurunegala</h1><br /><p><?php echo "All Complaint : ".$Kurunegala_all."<br>"."Not Process Complaint : ".$Kurunegala_not."<br>"."In Process Complaint : ".$Kurunegala_in."<br>"."Closed Complaint : ".$Kurunegala_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Puttalam</h1><br /><p><?php echo "All Complaint : ".$Puttalam_all."<br>"."Not Process Complaint : ".$Puttalam_not."<br>"."In Process Complaint : ".$Puttalam_in."<br>"."Closed Complaint : ".$Puttalam_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Ratnapura</h1><br /><p><?php echo "All Complaint : ".$Ratnapura_all."<br>"."Not Process Complaint : ".$Ratnapura_not."<br>"."In Process Complaint : ".$Ratnapura_in."<br>"."Closed Complaint : ".$Ratnapura_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Galle</h1><br /><p><?php echo "All Complaint : ".$Galle_all."<br>"."Not Process Complaint : ".$Galle_not."<br>"."In Process Complaint : ".$Galle_in."<br>"."Closed Complaint : ".$Galle_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Hambantota</h1><br /><p><?php echo "All Complaint : ".$Hambantota_all."<br>"."Not Process Complaint : ".$Hambantota_not."<br>"."In Process Complaint : ".$Hambantota_in."<br>"."Closed Complaint : ".$Hambantota_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Matara</h1><br /><p><?php echo "All Complaint : ".$Matara_all."<br>"."Not Process Complaint : ".$Matara_not."<br>"."In Process Complaint : ".$Matara_in."<br>"."Closed Complaint : ".$Matara_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Badulla</h1><br /><p><?php echo "All Complaint : ".$Badulla_all."<br>"."Not Process Complaint : ".$Badulla_not."<br>"."In Process Complaint : ".$Badulla_in."<br>"."Closed Complaint : ".$Badulla_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Monaragala</h1><br /><p><?php echo "All Complaint : ".$Monaragala_all."<br>"."Not Process Complaint : ".$Monaragala_not."<br>"."In Process Complaint : ".$Monaragala_in."<br>"."Closed Complaint : ".$Monaragala_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Kegalla</h1><br /><p><?php echo "All Complaint : ".$Kegalle_all."<br>"."Not Process Complaint : ".$Kegalle_not."<br>"."In Process Complaint : ".$Kegalle_in."<br>"."Closed Complaint : ".$Kegalle_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Colombo</h1><br /><p><?php echo "All Complaint : ".$Colombo_all."<br>"."Not Process Complaint : ".$Colombo_not."<br>"."In Process Complaint : ".$Colombo_in."<br>"."Closed Complaint : ".$Colombo_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Gampaha</h1><br /><p><?php echo "All Complaint : ".$Gampaha_all."<br>"."Not Process Complaint : ".$Gampaha_not."<br>"."In Process Complaint : ".$Gampaha_in."<br>"."Closed Complaint : ".$Gampaha_close?></p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Kalutara</h1><br /><p><?php echo "All Complaint : ".$Kalutara_all."<br>"."Not Process Complaint : ".$Kalutara_not."<br>"."In Process Complaint : ".$Kalutara_in."<br>"."Closed Complaint : ".$Kalutara_close?></p>",
