...
float: right;
    ...
    text-align: auto;
"> 
<a href="?userEmail=<?php echo $userEmail;?>&code=<?php echo $code;?>&lang=en"  <?php if($lang == 'en'){?> style="color:#ff9900;" <?php } ?>><font size="5px" style="color:#ff9900;">English</font></a>&nbsp;|
<a href="?userEmail=<?php echo $userEmail;?>&code=<?php echo $code;?>&lang=si"  <?php if($lang == 'si'){?> style="color:#ff9900;" <?php } ?>><font size="5px" style="color:#ff9900;">සිංහල</font></a>&nbsp;|
<a href="?userEmail=<?php echo $userEmail;?>&code=<?php echo $code;?>&lang=ta"  <?php if($lang == 'ta'){?> style="color:#ff9900;" <?php } ?>><font size="4px" style="color:#ff9900;">தமிழ்</font></a></div></selection>
                 </h4>
