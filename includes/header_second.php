...
float: right;
    ...
    text-align: auto;
"> 
<a href="?lang=en"  <?php if($lang == 'en'){?> style="color:#ff9900;" <?php } ?>><font size="5px" style="color:#ff9900;">English</font></a>&nbsp;|
<a href="?lang=si"  <?php if($lang == 'si'){?> style="color:#ff9900;" <?php } ?>><font size="5px" style="color:#ff9900;">සිංහල</font></a>&nbsp;|
<a href="?lang=ta"  <?php if($lang == 'ta'){?> style="color:#ff9900;" <?php } ?>><font size="4px" style="color:#ff9900;">தமிழ்</font></a></div></selection>
                 </h4>
                <span class="menu"></span>
                <div class="top-menu">
                    <ul>
                        <div class="space"><br></div>
                        <a href="?lang=en"  <?php if($lang == 'en'){?> style="color:#ff9900;" <?php } ?>><button class="as">English</button></a>
                        <a href="?lang=si"  <?php if($lang == 'si'){?> style="color:#ff9900;" <?php } ?>><button class="as">Sinhala</button></a>
                        <a href="?lang=ta"  <?php if($lang == 'ta'){?> style="color:#ff9900;" <?php } ?>><button class="as">Tamil</button></a>
                        <li><a href="../index.php"><?php echo $language["home"];?></a></li>                                       
                        <li><a href="index.php"><?php echo $language["login"]; ?></a></li>
                        <li><a href="registration.php"><?php echo $language["register"]; ?></a></li>
