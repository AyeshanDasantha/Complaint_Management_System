...
<a href="?lang=ta"  <?php if($lang == 'ta'){?> style="color:#ff9900;" <?php } ?>><font size="4px" style="color:#ff9900;">தமிழ்</font></a></div></selection>
                ...
                <div class="top-menu">
                    <ul>
                        ...
                        <a href="?lang=en"  <?php if($lang == 'en'){?> style="color:#ff9900;" <?php } ?>><button class="as"><b>English</b></button></a>
                        <a href="?lang=si"  <?php if($lang == 'si'){?> style="color:#ff9900;" <?php } ?>><button class="as"><b>සිංහල</b></button></a>
                        <a href="?lang=ta"  <?php if($lang == 'ta'){?> style="color:#ff9900;" <?php } ?>><button class="as"><b>தமிழ்</b></button></a>
