...
try {
    ...
    $body='<b>Hello</b> '.$fullname.' ,
        <br>
        <b>Admin Change Your Account Details.Here is your Updated Details</b>
        <br>
        <br>
        <b>your New Name :</b> '.$fullname.'
        <br>
        <b>your New Login Email address :</b> '.$email.'
        <br>
        <b>your New Contact No :</b> '.$contactno.'
        <br>
        <br>
    ...
    $mail->Subject = 'Update Account Details';
    $mail->Body    = $body;
    $mail->AltBody = strip_tags($body);

    $mail->send();
    $successmsg="Updated Details Send Him/His Email !!";
} catch (Exception $e) {
